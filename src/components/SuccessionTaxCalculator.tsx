        ...
        <div className="mt-8 rounded-xl border border-primary/25 bg-gradient-to-b from-card to-background p-6 md:p-7 shadow-[0_0_40px_-15px_rgba(184,142,67,0.12)]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <span className="font-body text-sm text-muted-foreground">Hai dei dubbi? Contattaci:</span>
              <div className="flex items-center gap-2">
                <a href="tel:+390292892296" aria-label="Chiamaci" className="w-9 h-9 rounded-full border border-primary/30 flex items-center justify-center text-primary hover:bg-primary/10 hover:border-primary/50 transition-all duration-200">
                ...
                <a href="https://wa.me/393793511586" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-9 h-9 rounded-full border border-primary/30 flex items-center justify-center text-primary hover:bg-primary/10 hover:border-primary/50 transition-all duration-200">
                ...
                <a href="mailto:info@websuccessioni.it" aria-label="Email" className="w-9 h-9 rounded-full border border-primary/30 flex items-center justify-center text-primary hover:bg-primary/10 hover:border-primary/50 transition-all duration-200">
