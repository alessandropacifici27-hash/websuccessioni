...
const guides = [
  ...
  },
  {
    category: "Costi",
    categoryColor: "bg-primary/15 text-primary",
    title: "Imposta di Successione: Aliquote, Franchigie e Calcolo",
    description: "Aliquote per grado di parentela, franchigie, esenzioni e autoliquidazione dal 2025. Tutto quello che serve per calcolare l'imposta.",
    time: "6 min",
    link: "/guide/imposta-successione",
  },
  {
    category: "Documenti",
    categoryColor: "bg-emerald-500/15 text-emerald-400",
    title: "Successione del Conto Corrente Bancario: Guida Completa",
    description: "Blocco del conto, documenti per sblocco e liquidazione, atto notorio e tempi. Cosa fare quando il defunto era titolare di un conto.",
    time: "5 min",
    link: "/guide/successione-conto-corrente",
  },
  {
    category: "Successione",
    categoryColor: "bg-sky-500/15 text-sky-400",
    title: "Successione tra Fratelli e Sorelle: Quote e Imposte",
    description: "Diritti successori di fratelli e sorelle, differenza tra germanici e unilaterali, aliquota 6% e franchigia 100.000 euro.",
    time: "4 min",
    link: "/guide/successione-fratelli-sorelle",
  },
  {
    category: "Nozioni",
    categoryColor: "bg-teal-500/15 text-teal-400",
    title: "Quote di Legittima: Cosa Spetta agli Eredi per Legge",
    description: "Chi sono i legittimari, le quote di riserva per figli e coniuge, azione di riduzione e riforma Legge 182/2025.",
    time: "5 min",
    link: "/guide/quote-legittima",
  },
  {
    category: "Immobili",
    categoryColor: "bg-amber-500/15 text-amber-400",
    title: "Successione di Auto e Veicoli: Procedura e Documenti",
    description: "Voltura al PRA dopo il decesso: documenti necessari, valore da dichiarare, imposte e tempi per intestare i veicoli agli eredi.",
    time: "5 min",
    link: "/guide/successione-auto-veicoli",
  },
  {
    category: "Debiti",
    categoryColor: "bg-red-500/15 text-red-400",
    title: "Eredità con Debiti: Cosa Rischia l'Erede",
    description: "Responsabilità per i debiti del defunto, accettazione con beneficio di inventario e rinuncia per tutelare il proprio patrimonio.",
    time: "4 min",
    link: "/guide/eredita-debiti",
  },
  {
    category: "Coniuge",
    categoryColor: "bg-pink-500/15 text-pink-400",
    title: "Successione in caso di Separazione o Divorzio",
    description: "Diritti del coniuge separato con e senza addebito, ex coniuge divorziato, convivente di fatto e unioni civili.",
    time: "5 min",
    link: "/guide/successione-separazione-divorzio",
  },
  {
    category: "Successione",
    categoryColor: "bg-sky-500/15 text-sky-400",
    title: "Successione tra Nonni e Nipoti: Rappresentazione e Quote",
    description: "Quando i nipoti subentrano per rappresentazione, quote e aliquote fiscali per nipoti in linea retta e collaterale.",
    time: "4 min",
    link: "/guide/successione-nonni-nipoti",
  },
  {
    category: "Rinuncia",
    categoryColor: "bg-violet-500/15 text-violet-400",
    title: "Rinuncia all'Eredità: Termini, Procedura e Conseguenze Fiscali",
    description: "Forma notarile o cancelliere, termine 10 anni, revoca, accrescimento della quota e obblighi fiscali della rinuncia.",
    time: "5 min",
    link: "/guide/rinuncia-eredita-guida",
  },
  {
    category: "Nozioni",
    categoryColor: "bg-teal-500/15 text-teal-400",
    title: "Polizze Vita e Successione: Cosa Sapere",
    description: "Esenzione dall'imposta di successione, rapporto con la legittima e obblighi dichiarativi per il beneficiario.",
    time: "4 min",
    link: "/guide/polizze-vita-successione",
  },
];
