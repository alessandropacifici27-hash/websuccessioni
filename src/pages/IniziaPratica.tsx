      ...
      >
        ...
        <div className="border border-primary/40 bg-card rounded-lg p-5">
          <p className="font-body text-sm text-foreground">
            Dopo l'invio riceverai entro pochi minuti una email di conferma con il numero della tua pratica. Entro 24 ore ti contatteremo se necessitiamo di integrazioni documentali. La dichiarazione di successione completata ti sarà inviata entro 48 ore per la firma.
          </p>
        </div>
